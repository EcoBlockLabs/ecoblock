...
func createTestNodeOnL1WithConfigImpl(
	...
	currentNode, err = arbnode.CreateNode(
		ctx, l2stack, l2chainDb, l2arbDb, NewFetcherFromConfig(nodeConfig), l2blockchain, l1client, l1info.ChainId,
...
func Create2ndNodeWithConfig(
	...
	currentNode, err := arbnode.CreateNode(ctx, l2stack, l2chainDb, l2arbDb, NewFetcherFromConfig(nodeConfig), l2blockchain, l1client, l1info.ChainId, first.DeployInfo, &txOpts, dataSigner, feedErrChan)
	Require(t, err)

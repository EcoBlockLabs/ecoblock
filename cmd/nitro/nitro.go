...
func mainImpl() int {
	...
	if nodeConfig.Node.Staker.OnlyCreateWalletContract {
		...
		l1Reader := headerreader.New(l1Client, l1ChainId, func() *headerreader.Config { return &liveNodeConfig.get().Node.L1Reader })
...
func ParseNode(ctx context.Context, args []string) (*NodeConfig, *genericconf.WalletConfig, *genericconf.WalletConfig, *ethclient.Client, *big.Int, error) {
	...
	if l1ChainId.Uint64() == 1 { // mainnet
		...
		case 0:
			return nil, nil, nil, nil, nil, errors.New("must specify --l2.chain-id to choose rollup")
		case 630:
			if err := applyEcoBlockBscMainnetParameters(k); err != nil {
				return nil, nil, nil, nil, nil, err
			}
			chainFound = true
		}
	} else if l1ChainId.Uint64() == 97 { // Bsc testnet
		switch l2ChainId {
		case 0:
			return nil, nil, nil, nil, nil, errors.New("must specify --l2.chain-id to choose rollup")
		case 631:
			if err := applyEcoBlockBscTestnetParameters(k); err != nil {
				return nil, nil, nil, nil, nil, err
			}
			chainFound = true
		}
...
func applyEcoBlockBscMainnetParameters(k *koanf.Koanf) error {
	// TODO update EcoBlock mainnet config
	return k.Load(confmap.Provider(map[string]interface{}{
		"persistent.chain":                   "ecoblock",
		"node.forwarding-target":             "https://rpc.ecoblock.tech",
		"node.feed.input.url":                "wss://rpc.ecoblock.tech/feed",
		"l1.rollup.bridge":                   "",
		"l1.rollup.inbox":                    "",
...
func applyEcoBlockBscTestnetParameters(k *koanf.Koanf) error {
	return k.Load(confmap.Provider(map[string]interface{}{
		"persistent.chain":                   "ecoblock-rollup",
		"node.forwarding-target":             "https://rpc-testnet.ecoblock.tech",
		"node.feed.input.url":                "wss://rpc-testnet.ecoblock.tech/feed",
		"l1.rollup.bridge":                   "0xed16681b27f3239ef352f51fa5b03460b863c29f",
		"l1.rollup.inbox":                    "0x812f40cc7b0fdaa7387de75368e175367e6fec56",
		"l1.rollup.sequencer-inbox":          "0x70f3117c714c9e09c53db431afd10360a6c17a56",
		"l1.rollup.rollup":                   "0x719adb12dbadc772b5160a5fbf32e398229c0939",
		"l1.rollup.validator-utils":          "0xa58e9437de26511dcee51f9cf80eb3561b41eae1",
		"l1.rollup.validator-wallet-creator": "0x6e1d80fb215521da0542ede3715ba7ab5d9174c3",
		"l1.rollup.deployed-at":              30516019,
		"l2.chain-id":                        631,
	}, "."), nil)
}

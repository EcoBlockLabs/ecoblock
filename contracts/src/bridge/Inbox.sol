...
contract Inbox is DelegateCallAware, PausableUpgradeable, IInbox {
        ...
        returns (uint256)
    {
        ...
        return (1400 + 6 * dataLength) * (baseFee == 0 ? 0 : baseFee); // TODO replace by block.basefee
    }
    ...
    function unsafeCreateRetryableTicket(
        ...
        uint256 submissionFee = calculateRetryableSubmissionFee(data.length, 0); // TODO replace by block.basefee
